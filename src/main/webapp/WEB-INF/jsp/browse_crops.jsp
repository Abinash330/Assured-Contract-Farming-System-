                                    ...
                                    <c:when test="${not empty crops}">
                                        <c:forEach var="crop" items="${crops}">
                                            ...
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <c:set var="imagePath" value="https://images.unsplash.com/photo-1595856728362-7f7cd71d18f5?w=500&auto=format&fit=crop" />
                                                </c:otherwise>
                                            </c:choose>
                                            ...
                                            <div class="col">
                                                <div class="card border-0 shadow-sm transition hover-elevate rounded-4 overflow-hidden h-100 d-flex flex-column" style="background: rgba(255,255,255,0.98);">
                                                    ...
                                                    <div class="card-body p-4 d-flex flex-column flex-grow-1">
                                                        ...
                                                        <form action="/contract/create" method="post" class="mt-auto">
                                                            <input type="hidden" name="crop_id" value="${crop.id}">
                                                            <button type="submit" class="btn btn-primary w-100 rounded-pill fw-bold py-3 shadow-sm hover-elevate transition d-flex justify-content-center align-items-center gap-2">
